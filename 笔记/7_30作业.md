          ...
          args:
            - |
              ...
              scrape_configs:
                - job_name: 'prometheus'
                  static_configs:
                    - targets: ['10.15.200.241:9091','10.15.200.241:8080','10.15.200.243:9100','10.15.200.243:8080','10.15.200.242:9100','10.15.200.242:8080']" > /etc/prometheus/prometheus.yml
          volumeMounts:
            - name: config
